...
export default function AboutPage() {
  ...
  const closeModal = () => { setModalOpen(false); setResult(null); };
  ...
  return (
    <LandingLayout>
      ...
      {/* DEMO MODAL */}
      {modalOpen && (
        <div className="l-modal-overlay" onClick={e => e.target === e.currentTarget && closeModal()}>
          <div className="l-modal">
            <button className="l-modal-close" onClick={closeModal}><X size={16} /></button>
